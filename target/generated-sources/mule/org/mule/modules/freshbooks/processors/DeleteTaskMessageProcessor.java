...
/**
 * DeleteTaskMessageProcessor invokes the {@link org.mule.modules.freshbooks.FreshBooksConnector#deleteTask(java.lang.String, org.mule.modules.freshbooks.model.Task, java.lang.String)} method in {@link FreshBooksConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedSourceToken = ((String) evaluateAndTransform(getMuleContext(), event, DeleteTaskMessageProcessor.class.getDeclaredField("_sourceTokenType").getGenericType(), null, sourceToken));
            final Task _transformedTask = ((Task) evaluateTransformForPayload(getMuleContext(), event, DeleteTaskMessageProcessor.class.getDeclaredField("_taskType").getGenericType(), null, task));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((FreshBooksConnector) object).deleteTask(_transformedSourceToken, _transformedTask, _transformedAccessTokenId);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at FreshBooksConnector at deleteTask retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
