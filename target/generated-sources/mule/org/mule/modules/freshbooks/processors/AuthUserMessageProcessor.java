...
/**
 * AuthUserMessageProcessor invokes the {@link org.mule.modules.freshbooks.FreshBooksConnector#authUser(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.Map)} method in {@link FreshBooksConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public AuthUserMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((FreshBooksConnector) object).authUser(_transformedRequestTokenUrl, _transformedAccessTokenUrl, _transformedAuthorizationUrl, _transformedCallbackUrl, _transformedRequestTokenId, _transformedHeaders);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at FreshBooksConnector at authUser retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
