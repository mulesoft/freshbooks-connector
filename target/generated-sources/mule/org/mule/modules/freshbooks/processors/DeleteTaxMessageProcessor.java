...
/**
 * DeleteTaxMessageProcessor invokes the {@link org.mule.modules.freshbooks.FreshBooksConnector#deleteTax(java.lang.String, org.mule.modules.freshbooks.model.Tax, java.lang.String)} method in {@link FreshBooksConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.2", date = "2015-12-11T05:53:18-03:00", comments = "Build 3.7.x.2633.51164b9")
public class DeleteTaxMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public DeleteTaxMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedSourceToken = ((String) evaluateAndTransform(getMuleContext(), event, DeleteTaxMessageProcessor.class.getDeclaredField("_sourceTokenType").getGenericType(), null, sourceToken));
            final Tax _transformedTax = ((Tax) evaluateTransformForPayload(getMuleContext(), event, DeleteTaxMessageProcessor.class.getDeclaredField("_taxType").getGenericType(), null, tax));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((FreshBooksConnector) object).deleteTax(_transformedSourceToken, _transformedTax, _transformedAccessTokenId);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at FreshBooksConnector at deleteTax retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
