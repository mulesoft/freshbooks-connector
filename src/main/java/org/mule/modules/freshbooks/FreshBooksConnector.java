...
public class FreshBooksConnector {
    ...
    public Category getCategory(@Optional String sourceToken, String categoryId,
            @Optional String accessTokenId) {
        return (Category) config.getClient().get(getAccessTokenInformation(accessTokenId),
    ...
    public Client getClient(@Optional String sourceToken, String clientId,
            @Optional String accessTokenId) {
        return (Client) config.getClient().get(getAccessTokenInformation(accessTokenId),
    ...
    public Invoice getInvoice(@Optional String sourceToken, String invoiceId,
            @Optional String accessTokenId)
    {
        return (Invoice) config.getClient().get(getAccessTokenInformation(accessTokenId),
    ...
    public Item getItem(@Optional String sourceToken, String itemId,
            @Optional String accessTokenId)
    {
        return (Item) config.getClient().get(getAccessTokenInformation(accessTokenId),
    ...
    public Tax getTax(@Optional String sourceToken, String taxId,
            @Optional String accessTokenId)
    {
        return (Tax) config.getClient().get(getAccessTokenInformation(accessTokenId),
    ...
    public Task getTask(@Optional String sourceToken, String taskId,
            @Optional String accessTokenId)
    {
        return (Task) config.getClient().get(getAccessTokenInformation(accessTokenId),
    ...
    public Payment getPayment(@Optional String sourceToken, String paymentId,
            @Optional String accessTokenId)
    {
        return (Payment) config.getClient().get(getAccessTokenInformation(accessTokenId),
    ...
    public Iterable<Addon> listAddons(@Optional String sourceToken,
            @Optional String accessTokenId)
    {
        return ((Addons) config.getClient().getListObject(getAccessTokenInformation(accessTokenId),
    ...
    {
        String authUrl = new DefaultFreshBooksOAuthClient(config.getClient().getApiKey(), config.getClient().getApiSecret(), config.getObjectStore()).
    ...
    public OAuthCredentials getAccessToken(@Optional String apiUrl, @Default("#[header:inbound:oauth_verifier]") String verifier, 
            @Default("#[header:inbound:userId]") String requestTokenId, @Optional String userIdentifier)
                    throws OAuthMessageSignerException, OAuthNotAuthorizedException, 
                    OAuthExpectationFailedException, OAuthCommunicationException, ObjectStoreException
    {
        OAuthCredentials credentials = new DefaultFreshBooksOAuthClient(config.getConsumerKey(), config.getConsumerSecret(), 
                config.getObjectStore()).getAccessToken(verifier, requestTokenId);
